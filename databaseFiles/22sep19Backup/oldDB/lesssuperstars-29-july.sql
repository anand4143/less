...
(17,2,'pB-level1',1,NULL,1,1,0,NULL,'2019-07-26 10:57:10','2019-07-26 10:57:43');
...
insert  into `master_contests`(`id`,`uniqueCode`,`contestName`,`description`,`startDate`,`endDate`,`status`,`isDeleted`,`eby`,`createdDate`,`updatedDate`) values 
...
CREATE TABLE `user_smule` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `userID` int(10) unsigned NOT NULL COMMENT 'users table id',
  `contestID` int(10) unsigned NOT NULL COMMENT 'master_contests table id',
  `levelID` int(10) unsigned NOT NULL COMMENT 'contest_levels table id',
  `smuleUrl` varchar(1024) NOT NULL,
  `smuleID` varchar(1024) NOT NULL COMMENT 'this is smule app id',
  `isDeleted` tinyint(1) unsigned DEFAULT '0' COMMENT '1=deleted, 0= active record',
  `eby` int(11) unsigned DEFAULT NULL COMMENT 'users table id',
  `createdDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedDate` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=latin1 COMMENT='This is mapping b/w user and smule URL';

/*Data for the table `user_smule` */

insert  into `user_smule`(`id`,`userID`,`contestID`,`levelID`,`smuleUrl`,`smuleID`,`isDeleted`,`eby`,`createdDate`,`updatedDate`) values 
(1,18,3,11,'https://test1.com','',0,NULL,'2019-07-30 00:27:44','2019-07-30 00:27:44'),
(2,18,3,11,'https://test2.com','',0,NULL,'2019-07-30 00:27:45','2019-07-30 00:27:45'),
(3,18,3,11,'https://test3.com','',0,NULL,'2019-07-30 00:35:55','2019-07-30 00:35:55'),
(4,18,3,11,'https://test4.com','',0,NULL,'2019-07-30 00:36:18','2019-07-30 00:36:18'),
(5,18,3,11,'https://test5.com','',0,NULL,'2019-07-30 00:36:45','2019-07-30 00:36:45');
...
insert  into `users`(`id`,`userName`,`email`,`firstName`,`lastName`,`password`,`userType`,`createdDate`,`isActive`,`isDeleted`,`aboutUser`,`updatedData`) values 
(1,'anand4143','anand.knp@gmail.com','anand','shukla','202cb962ac59075b964b07152d234b70',1,'2019-07-09 10:32:38',0,0,'','0000-00-00 00:00:00'),
(2,'saurabh4143123','verma.thegreat92@gmail.com','Sourabh123','Verma','202cb962ac59075b964b07152d234b70',2,'2019-07-21 10:32:53',0,0,'','0000-00-00 00:00:00'),
(3,'deep','deepeshtct@gmail.com','Deepesh','Singh','dd4936bf8f4c399b2bd95c07486172b5',1,'2019-07-24 22:38:39',1,0,'','0000-00-00 00:00:00'),
(4,'','harijjmd@gmail.com','Hari','Choudhary','202cb962ac59075b964b07152d234b70',2,'2019-07-19 01:23:30',1,0,'','0000-00-00 00:00:00'),
(15,'judge1','judge1@lesssuperstar.com','judge1','judge1123','',2,'2019-07-18 08:53:02',1,0,'judge1judge1judge1judge1judge1judge1 judge1judge1judge1 judge1judge1judge1judge1judge1','0000-00-00 00:00:00'),
(16,'judge2','judge2@lesssuperstar.com','judge22','judge2','',2,'2019-07-18 08:52:58',1,0,'judge2judge2judge2 judge2judge2judge2judge2 judge2','0000-00-00 00:00:00'),
(17,'saurabh4143123','saurabh4143123@lesssuperstar.com','anand','shukla','',2,'2019-07-18 08:52:52',1,0,'this is testing judge','0000-00-00 00:00:00'),
(14,'anandd','ananddshukkla@lesssuperstart.com','ANAND123','SHUKLA','',2,'2019-07-18 08:30:06',1,0,'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged','0000-00-00 00:00:00'),
(18,'deepesh2','deepesh@test.com','Deepesh','Singh','dd4936bf8f4c399b2bd95c07486172b5',3,'2019-07-24 22:16:36',0,0,'','0000-00-00 00:00:00');
...
CREATE TABLE `users_contests_levels` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='This table is mapping of users,master_contests,and levels';
...
CREATE TABLE `users_judge` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='relation b/w master_judge & users tables';

/*Data for the table `users_judge` */

insert  into `users_judge`(`id`,`judge_id`,`user_id`,`contest_id`,`levels_id`) values 
(3,1,18,3,11),
(4,1,18,2,17);
