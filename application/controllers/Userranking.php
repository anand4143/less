...
class Userranking extends MY_Controller {
    ...
    public function index(){
        $data = array();
        $this->load->view('frontend/userranking/index', $data);
    }
	...
	public function contestList(){
		...
		$this->load->view('frontend/userranking/contestList', $data);
	}
	...
	public function levelList(){
		...
		//echo "<pre>";print_r($rs);
		$data['levelList'] = $rs;
		$this->load->view('frontend/userranking/levelList', $data);
	}
	...
	$this->load->view('frontend/userranking/userLevelRanking', $data);
